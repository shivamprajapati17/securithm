...
const FAQS = [
  ...
  },
  {
    ...
    a: "No. The basic scan is free and requires no signup. Creating an account keeps your scan history private to your login, unlocks fix downloads, CI/CD integration and team seats.",
  },
  {
      ...
      <main>
        ...
        <section className="mm-container pb-16 pt-10 text-center md:pb-24 md:pt-16">
          <p data-reveal className="mm-eyebrow">
            Eleven trained agents · one cream canvas
          </p>
          <h1
            data-reveal
          ...
          >
            AuditAI dispatches a family of security agents over your Solidity —
            real line numbers, severity-tagged findings, and a fixed contract
            you can download when the scan is done.
          </p>
          <div
            data-reveal
          ...
          {/* Product mock — dark frame against the warm canvas */}
          <div
            data-reveal
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
            {[
              ...
              >
                ...
                <div className="mm-eyebrow mt-2">{l}</div>
              </div>
            ))}
          </div>
        </section>
        ...
        {/* ── SCAN → FIX → DOWNLOAD — the loop, lime wash ── */}
      ...
      <footer className="mm-container pb-12 pt-6">
        <div className="grid gap-10 md:grid-cols-[1.5fr_1fr_1fr_1fr]">
          ...
          {[
            ...
            <div key={col.head}>
              <p className="mm-eyebrow">{col.head}</p>
